...
/* 空状态欢迎语：从真实画像/目标拼接（非模板）——"我记得你在学正则化"
   2026-08-29：星尘精灵按用户指定先只做应用图标/启动画面，暂不放主界面
   （原图 4096² 14.5MB 进 dist 会拖垮首屏——图标用缩放副本，主界面等精灵小图方案就绪再上） */
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="text-center">
        ...
        <p className="font-logo text-3xl text-primary tracking-[0.08em] animate-welcome-light">
          拾光
        </p>
