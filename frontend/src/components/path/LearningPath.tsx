        ...
        <div className="rounded-lg border border-hairline bg-surface overflow-hidden">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className={`text-sm px-1.5 py-0.5 rounded bg-elevated ${st.text}`}>
                  {t.status}
                </span>
              </div>
          ...
          {expanded && (
            <div className="px-3 pb-2.5 border-t border-hairline">
              ...
              {t.reflections && t.reflections.length > 0 && (
                <div className="py-2 border-b border-hairline/50">
                  <div className="text-[10px] uppercase tracking-wider text-warning mb-1">
                    反思 · {t.reflections.length}
                  </div>
                  <div className="text-[12px] text-ink/80 leading-relaxed line-clamp-2">
                    {t.reflections[0]}
                  </div>
                </div>
              )}
              ...
              {t.memories.length > 5 && (
                <div className="text-[11px] text-ink-dim/80 pt-1.5">
                  + {t.memories.length - 5} 条星尘（在星尘查看全部）
                </div>
              )}
              ...
              {edit && edit.topic === t.name && (
                <div className="flex flex-col gap-1.5 pt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={doEdit}
                      className="text-[11px] px-2 py-1 rounded bg-primary/20 text-primary"
                    >
                      确认
                    </button>
                    <button
                      onClick={() => setEdit(null)}
                      className="text-[11px] px-2 py-1 rounded text-ink-dim"
                    >
                      取消
                    </button>
                  </div>
